      ...
      if (isAcceptedTc) {
        ...
        Map req = {
          ...
          'password': widget.socialLogin
              ? dni_numberController.text.trim()
          ...
          */
          ...
          'additional_id': [selectedAdditional],
        };
          ...
          authService
              .signUpWithEmailPassword(context,
                  mobileNumber: widget.socialLogin
                      ? '${widget.countryCode}${widget.dni_number}'
                      : '$countryCode${phoneController.text.trim()}',
                  email: emailController.text.trim(),
                  fName: firstController.text.trim(),
                  lName: lastNameController.text.trim(),
                  dni_number: widget.socialLogin
                      ? widget.dni_number
                      : dni_numberController.text.trim(),
                  password: widget.socialLogin
                      ? widget.dni_number
                  ...
                  content: Form(
                      ...
                      child:
                        ...
                        children: listAdicionales.map((e) {
                          return inkWellWidget(
                            onTap: () {
                              selectedAdditional = listAdicionales.toList();
                              setState(() {});
                            },
                            child: Container(
                              margin: EdgeInsets.only(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                    color: selectedAdditional ==
                                            listAdicionales.toList()
                                        ? Colors.green
                                        : primaryColor.withOpacity(0.5)),
                                borderRadius:
                                    BorderRadius.circular(defaultRadius),
                              ...
                              child: Row(
                                children: [
                                  /*
                                      ...
                                      */
                                  Expanded(
                                    child: Text(e.data as String,
                                        style: boldTextStyle()),
                                  ),
                                  Visibility(
                                    visible: selectedAdditional ==
                                        listAdicionales.toList(),
                                    child: Icon(Icons.check_circle_outline,
                                        color: Colors.green),
                                  )
