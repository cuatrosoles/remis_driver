...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void init() async {
    ...
    getUserDetail(userId: sharedPref.getInt(USER_ID)).then((value) {
      ...
      dni_numberController.text = value.data!.dni_number.validate();
      ...
      sharedPref.setString(DNI, value.data!.dni_number.validate());
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    nextFocus: firstnameFocus,
                    decoration: inputDecoration(context, label: 'DNI'),
