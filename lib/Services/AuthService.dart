...
class AuthServices {
    ...
    try {
      createAuthUser(email, password, isOtpLogin).then((user) async {
        if (user != null) {
          ...
          userModel.dni_number = dni_number.validate();
  ...
  Future<void> loginFromFirebaseUser(User currentUser,
    ...
    if (await userService.isUserExist(loginDetail!.data!.email)) {
      ...
      userModel.dni_number = loginDetail.data!.dni_number.validate();
...
class GoogleAuthServices {
  ...
  Future<void> signInWithGoogle(BuildContext context) async {
    ...
    if (googleSignInAccount != null) {
      print('DATAAAAAAAAAA---001 ' + (googleSignInAccount).toString());
      //Authentication
      ...
      try {
        ...
        print('DATAAAAAAAAAA---011 ' + (credential).toString());
        print('DATAAAAAAAAAA---022 ' + (authResult).toString());

        ///final UserCredential authResult =
        ///    await _auth.signInWithCredential(credential);

        ///
        ///print('DATAAAAAAAAAA---033 ' + (authResult).toString());
        ...
        print("Dataaaaaaaaaaaaaaaaa" + user.uid.toString());
