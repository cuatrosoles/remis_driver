...
*/
  ...
  late final _$currentRiderRequestAtom =
      Atom(name: '_AppStore.currentRiderRequest', context: context);

  @override
  OnRideRequest? get currentRiderRequest {
    _$currentRiderRequestAtom.reportRead();
    return super.currentRiderRequest;
  }

  @override
  set currentRiderRequest(OnRideRequest? value) {
    _$currentRiderRequestAtom.reportWrite(value, super.currentRiderRequest, () {
      super.currentRiderRequest = value;
    });
  }
  ...
  @override
  Future<void> setUserProfile(String val, {bool isInitialization = false}) {
    return _$setUserProfileAsyncAction.run(
        () => super.setUserProfile(val, isInitialization: isInitialization));
  }
...
currentRiderRequest: ${currentRiderRequest}
    ''';
  }
}
